...
| F39 | Normal 모드 코드 질문 차단 — supervisor 아닐 때 소스/내부 구현 질문 거부 (운영 질문은 steering 데이터로 응답) | active | feat/F39 (TBD) | .claude/worktrees/F39 (TBD) | — (monorepo) | 72aba01 | 2026-06-03 |
