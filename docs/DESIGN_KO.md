...
> ⚠️ **이 문서는 한국어 보존본입니다.** 정식(canonical) 설계 문서는 영문
> [DESIGN.md](DESIGN.md)이며, 향후 docs/README는 영어로 관리됩니다. 이 한국어 버전은
> 내용이 뒤처질 수 있습니다 — 최신 구조는 영문판을 참조하세요.
>
> 미국·한국 주식 자동 매매 시스템의 아키텍처 설계 문서.
